...
const starts = [findLocation('S'), ...findAllLocation('a')];
const distances = starts.map(findShortest);
console.log("shortest : ", distances.sort((a, b) => a - b).shift());
